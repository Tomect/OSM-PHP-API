...
//  Modified by Tom Turner for release with the OSM API suite
//  Version: 1.9.4.1
...
//constants 1
define("PROJECT", "phpLiteAdmin_OSMAPI");
...
define("SYSTEMPASSWORD", $DB_Password); // Makes things easier.
...
class Authorization
{
	...
	public function attemptGrant($DB_Password, $remember)
	{
		if ($DB_Password == SYSTEMPASSWORD) {
			if ($remember) {
